...
router.get(`${API_PREFIX}/drawings/:id`, permissionMiddleware.checkRole(['manager', 'impiegato', 'consulente']), permissionMiddleware.checkTeam, async (req: any, res: any) => CRUDController.readOneRecord(Drawing, req, res));
